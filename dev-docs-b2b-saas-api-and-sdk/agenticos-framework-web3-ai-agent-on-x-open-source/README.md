...
* **Twitter API credentials:** A Twitter Developer Project with OAuth 2.0 Client ID and Client Secret. [Generation Guide](./#agenticos-framework-web3-ai-agent-on-x-open-source).&#x20;
